...
import nguyentrinhan70.example.com.connect.SachService;
...
public class TimKiemUI extends JFrame {
	...
	private void addControls() {
		...
		pnNhap.setLayout(new FlowLayout(FlowLayout.LEFT));
		JLabel lblNhap = new JLabel("Nhập sách muốn tìm");
		txtTim = new JTextField(20);
		pnNhap.add(lblNhap);
		pnNhap.add(txtTim);
		pnNorth.add(pnNhap);
		
		btnBatDauTim = new JButton("Bắt đầu tìm");
		pnNhap.add(btnBatDauTim);
